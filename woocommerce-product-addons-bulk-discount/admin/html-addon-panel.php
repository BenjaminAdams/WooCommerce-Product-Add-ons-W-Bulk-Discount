<div id="product_addons_data" class="panel woocommerce_options_panel">
	...
	<div class="wc-metaboxes-wrapper">
        ...
        <div class="options_group">
			<p class="form-field">
            <label for="_product_addons_exclude_global"><?php _e( 'Exclude this product from Global Addons', 'wc_product_addons' ); ?></label>
...
<script type="text/javascript">
	jQuery(function(){
		...
		.on( 'change', 'select.product_addon_type', function() {
			...
			if ( value == 'custom' || value == 'custom_price' || value == 'custom_textarea' ) {
