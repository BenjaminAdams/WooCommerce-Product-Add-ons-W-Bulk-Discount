...
<tr>
	...
	<td class="discount_column"><input type="number" name="product_addon_option_discount[<?php echo $loop; ?>][]" value="<?php echo esc_attr($option['discount']) ?>" placeholder="0" min="0" step="any" /></td>
